...
def get_reports(host, query, business_name):
    url = f'{host}?{query}&$q="{business_name.capitalize()}"'
...
def getUserLocation():
    # location_url = 'http://freegeoip.net/json' // this source is dead
...
HOST = 'https://data.kingcounty.gov/resource/f29f-zza5.json'
PREVDAYS = 360
BOUND_RANGE = .10
