...
class CGIRootFix(object):
    ...
    and you have problems with your src root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your src is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your src, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the src.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        src = HeaderRewriterFix(src, remove_headers=['Date'],
